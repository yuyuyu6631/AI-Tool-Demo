        ...
        <div className="flex min-w-0 items-center gap-2 sm:shrink-0">
          {onCompareToggle ? (
            <button
              ...
              className={`inline-flex h-9 flex-1 items-center justify-center gap-1 rounded px-3 text-xs font-semibold transition focus:outline-none focus:ring-2 focus:ring-slate-400 sm:flex-none ${
                compareSelected
