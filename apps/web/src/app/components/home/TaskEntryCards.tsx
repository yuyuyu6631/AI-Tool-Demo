...
export default function TaskEntryCards() {
  return (
    <div className="mx-auto mt-8 grid w-full max-w-5xl gap-4 motion-safe:animate-[agentReveal_520ms_ease-out_360ms_both] md:grid-cols-3">
      {HOME_ENTRY_CARDS.map((entry, index) => {
        ...
        return (
          <Link
            ...
            prefetch
            className={`home-entry-card group relative overflow-hidden rounded-[8px] border p-6 text-left backdrop-blur-xl transition duration-150 hover:-translate-y-0.5 ${tone}`}
          >
